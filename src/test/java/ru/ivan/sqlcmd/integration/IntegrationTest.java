...
public class IntegrationTest {
    ...
    public void testHelp(){
        ...
        assertEquals("Привет, юзер\r\n" +
                ...
                "trunctateTable|table    -   очистка таблицы table от данных\r\n" +
    ...
    public void testFindAfterConnectWithData(){
        ...
        assertEquals("Привет, юзер\r\n" +
                ...
                "\r\n"+
                "Введите команду или help для помощи\r\n" +
                "В таблице 'users' успешно создана запись {id=13, name=Stiven, password=*****}\r\n"+
                "\r\n"+
                "\r\n"+
                "Введите команду или help для помощи\r\n" +
                "В таблице 'users' успешно создана запись {id=14, name=Eva, password=+++++}\r\n"+
                "\r\n"+
                "\r\n"+
                "Введите команду или help для помощи\r\n" +
                "+--+------+--------+\n" +
    ...
    public void testClearAfterConnectWithIllegalNumberOfArguments(){
        //given
        in.add("connect|sqlcmd|postgres|postgres");
        in.add("trunctateTable|users|asfaf");
        in.add("exit");
        ...
        assertEquals("Привет, юзер\r\n" +
                ...
                "\r\n"+
                "Введите команду или help для помощи\r\n" +
                "Неудача по причине: Формат команды 'trunctateTable|tableName', а ты ввел: trunctateTable|users|asfaf\r\n"+
                "Повтори попытку\r\n"+
                "\r\n"+
                "\r\n"+
                     "Введите команду или help для помощи\r\n" +
